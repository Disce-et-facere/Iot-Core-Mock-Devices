...
def publish_telemetry():
    ...
    while True:
        telemetry_data = {
            "ownerID": OWNER_ID,
            "deviceData": {
                "Temperature": round(20 + 10 * math.sin(t.time() / 10), 2),  # Simulated sine wave temperature
                "Temperature-unit": "Celsius",  # whatever unit you want to be displayed in the app
                "Humidity": round(50 + 20 * math.cos(t.time() / 10), 2),  # Simulated cosine wave humidity
                "Humidity-unit": "Percent",  # whatever unit you want to be displayed in the app
            }        
        }
        mqtt_connection.publish(
